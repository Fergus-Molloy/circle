defmodule CircleWeb.PostLive.Form do
  ...
  defp apply_action(socket, :edit, %{"id" => id}) do
    ...
    |> assign(:post, post)
    |> assign(:form, to_form(Feed.change_post(socket.assigns.current_scope, post)))
  end
  ...
  def handle_event("validate", %{"post" => post_params}, socket) do
    changeset = Feed.change_post(socket.assigns.current_scope, socket.assigns.post, post_params)
  ...
  defp save_post(socket, :edit, post_params) do
    case Feed.update_post(socket.assigns.current_scope, socket.assigns.post, post_params) do
      {:ok, post} ->
        {:noreply,
         socket
  ...
  defp save_post(socket, :new, post_params) do
    case Feed.create_post(socket.assigns.current_scope, post_params) do
      {:ok, post} ->
        {:noreply,
         socket
